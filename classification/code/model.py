...
class wasteModel_CNN(nn.Module):
    ...
    def forward(self, x):
        conv_layer1 = self.max_pool(self.relu(self.batch1(self.conv1(self.zero_padding(x)))))
        conv_layer2 = self.max_pool(self.relu(self.batch2(self.conv2(self.zero_padding(conv_layer1)))))
        conv_layer3 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer2)))))
        conv_layer4 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer3)))))
        conv_layer5 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer4)))))
        conv_layer6 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer5)))))
        conv_layer7 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer6)))))
        conv_layer8 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer7)))))
        conv_layer9 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer8)))))
        conv_layera = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer9)))))
        conv_layerb = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layera)))))
        conv_layerc = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layerb)))))
        conv_layerd = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layerc)))))
        conv_layere = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layerd)))))
        conv_layerf = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layere)))))
        conv_layer11 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layerf)))))
        conv_layer12 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer11)))))
        conv_layer13 = (self.relu(self.batch2(self.convC(self.zero_padding(conv_layer12)))))
        conv_flat = self.flat(conv_layer13)
